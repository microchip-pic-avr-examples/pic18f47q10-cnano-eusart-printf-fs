...
Run the code, start MPLAB® X Data Visualizer and configure it to display plots based on Data Steam protocol messages, as described in the [document](http://www.microchip.com/).
